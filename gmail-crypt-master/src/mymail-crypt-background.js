...
var gCryptAlerts = {
  ...
  gCryptUnableVerifySignature: {id: 'gCryptUnableVerifySignature', type: '', text: 'CS5321 Group5 extension For Gmail was unable to verify this message.',
    html: '<div class="alert" id="gCryptUnableVerifySignature">CS5321 Group5 extension  was unable to verify this message.</div>' },
  gCryptAbleVerifySignature: {id: 'gCryptAbleVerifySignature', type: 'success', text: 'CS5321 Group5 extension  was able to verify this message.',
    html: '<div class="alert alert-success" id="gCryptAbleVerifySignature">CS5321 Group5 extension  was able to verify this message.</div>'},
  gCryptAlertPassword: {id: 'gCryptAlertPassword', type: 'error', text: 'CS5321 Group5 extension was unable to read your key. Is your password correct?',
    html: '<div class="alert alert-error" id="gCryptAlertPassword">CS5321 Group5 extension was unable to read your key. Is your password correct?</div>'},
  gCryptAlertDecrypt: {id: 'gCryptAlertDecrypt', type: 'error', text: 'CS5321 Group5 extension was unable to decrypt this message.',
    html: '<div class="alert alert-error" id="gCryptAlertDecrypt">CS5321 Group5 extension was unable to decrypt this message.</div>'},
